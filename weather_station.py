...
print('{:^6} {:^5} {:^6} {:^6} {:^6} {:^6} {:^4} {:^6} {:^7} {:^6} {:^5} {}'.format('wdir','wspd','wgst','wchl','hidx','dewp','rnfl','humd','pres','temp','gtmp',time.ctime()))
...
##  w_dir w_spd w_gust wchill heatidx dewpt rain hum prsr a_temp g_temp time
    print('{:^6} {:^5} {:^6} {:^6} {:^6} {:^6} {:^4} {:^6} {:^7} {:^6} {:^5} {}'.format(wind_average, wind_speed, wind_gust, wchill, c2f(hidx), c2f(dewpt_c), round(mm2in(rainfall), 2), humidity, pressure, c2f(ambient_temp), c2f(ground_temp), time.ctime()))
    db.insert(c2f(ambient_temp), c2f(ground_temp), 0, pressure, humidity, wind_average, wind_speed, wind_gust, wchill, c2f(hidx), c2f(dewpt_c), round(mm2in(rainfall), 2))#, time.strftime("%Y-%m-%d %H:%M:%S"))
