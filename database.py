...
'''
This module includes modified versions of 
software developed by The Raspberry Pi Foundation
...
class oracle_apex_database:
    ...
    def upload(self, id, ambient_temperature, ground_temperature, air_quality, air_pressure, humidity, wind_direction, wind_speed, wind_gust_speed, wind_chill, heat_idx, dew_pt, rainfall, created):
...
class weather_database:
    def __init__(self):
        ...
        self.insert_template = "INSERT INTO WEATHER_MEASUREMENT (AMBIENT_TEMPERATURE, GROUND_TEMPERATURE, AIR_QUALITY, AIR_PRESSURE, HUMIDITY, WIND_DIRECTION, WIND_SPEED, WIND_GUST_SPEED, WIND_CHILL, HEAT_IDX, DEW_PT, RAINFALL, CPU_TEMP, CREATED) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, now());"
    ...
    def insert(self, ambient_temperature, ground_temperature, air_quality, air_pressure, humidity, wind_direction, wind_speed, wind_gust_speed, wind_chill, heat_idx, dew_pt, rainfall, cpu_temp):#, created = datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")):
